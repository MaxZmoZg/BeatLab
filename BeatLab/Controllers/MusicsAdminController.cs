...
namespace BeatLab.Controllers
{
    public class MusicsAdminController : Controller
    {
        ...
        // POST: MusicsAdmin/Create
        // Чтобы защититься от атак чрезмерной передачи данных, включите определенные свойства, для которых следует установить привязку. Дополнительные 
        // сведения см. в разделе https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "ID_Music,ID_Genere_of_Music,ID_Type_mysic,Name_music,Description_Music,ID_Alboms,IsDeleted,Music_file,Image_music,ID_User")] Music music)
        {
            ...
            ViewBag.ID_User = new SelectList(db.User, "ID_User", "Last_Name_User", music.ID_User);
            return View(music);
        }

        // GET: MusicsAdmin/Edit/5
        ...
        // POST: MusicsAdmin/Edit/5
        // Чтобы защититься от атак чрезмерной передачи данных, включите определенные свойства, для которых следует установить привязку. Дополнительные 
        // сведения см. в разделе https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Music,ID_Genere_of_Music,ID_Type_mysic,Name_music,Description_Music,ID_Alboms,IsDeleted,Music_file,Image_music,ID_User")] Music music)
        {
            if (ModelState.IsValid)
            {
