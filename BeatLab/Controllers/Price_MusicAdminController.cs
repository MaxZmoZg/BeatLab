...
{
    public class Price_MusicAdminController : Controller
    {
        private BeatLabDBEntities db = new BeatLabDBEntities();

        // GET: Price_MusicAdmin
        ...
        // GET: Price_MusicAdmin/Details/5
        ...
        // POST: Price_MusicAdmin/Delete/5
