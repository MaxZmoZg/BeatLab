...
namespace BeatLab
{
    ...
    public partial class Plugins
    {
        ...
        public Plugins()
        {
            ...
            this.Version_Plugins = new HashSet<Version_Plugins>();
        }
    
        public int ID_Plugin { get; set; }
        public System.DateTime Date_of_issue_Plugin { get; set; }
        public int ID_Format_Plugins { get; set; }
        ...
        public int Price_Plugin { get; set; }
    
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<Comments> Comments { get; set; }
        public virtual Format_Plugin Format_Plugin { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<Version_Plugins> Version_Plugins { get; set; }
    }
}
